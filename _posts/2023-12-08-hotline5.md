...
header:
  ...
  overlay_filter: 0.5
  actions:
    - label: "<a><i class='fab fa-instagram'></i> Instagram</a>"
      url: "https://www.instagram.com/hotline_5"
    - label: "Button 2"
      url: "#"
excerpt: "Außergewöhnlicher Smashed-Burger speziellem Extra."
author_profile: true
author: florian
sidebar:
  - text: |
